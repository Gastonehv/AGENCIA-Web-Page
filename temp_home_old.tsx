    ...
    return (
        <main ref={containerRef}>
            <SEO
                ...
                description="Lideramos la frontera de la IA Generativa, Arquitectura Digital y Automatizaci├│n. No somos una agencia con IA, somos la IA como agencia."
            />
            <StructuredData data={{
            ...
            <div className="narrative-wrapper" style={{ position: 'relative', zIndex: 10, backgroundColor: 'transparent', marginTop: '-100vh' }}>
                ...
                <section className="team-list" style={{ minHeight: '100vh', padding: '10vh 0', backgroundColor: '#FFFFFF', color: '#000', display: 'flex', flexDirection: 'column', position: 'relative' }}>
                    <h2 style={{ fontSize: 'clamp(3rem, 6vw, 6rem)', marginBottom: '6rem', fontWeight: 900, textAlign: 'center', letterSpacing: '0.02em', wordSpacing: '0.2em', color: '#000' }}>EL N├ÜCLEO</h2>
