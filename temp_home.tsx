...
const Home: React.FC = () => {
    ...
    const team = [
        ...
        { id: 2, role: 'CTO / AI LEAD', name: 'Or├ículo de Datos', img: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=1000&auto=format&fit=crop' },
        { id: 3, role: 'LEAD DEVELOPER', name: 'Tejedor de C├│digo', img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1000&auto=format&fit=crop' },
            ...
            <div className="narrative-wrapper" style={{ position: 'relative', zIndex: 10, backgroundColor: 'transparent', marginTop: '-100vh' }}>
                ...
                <section id="identidad-section" style={{
                    ...
                    <div style={{ paddingLeft: '5rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                        ...
                        <p className="identidad-body-text" style={{ fontFamily: 'var(--font-body)', fontSize: '1.25rem', lineHeight: 1.5, maxWidth: '600px', marginTop: '1rem', borderLeft: '4px solid #00FF99', paddingLeft: '1.5rem', color: '#333' }}>
                            Trascendemos la est├®tica convencional. <br />Orquestamos sistemas de inteligencia visual que no solo comunican, sino que dominan el entorno digital.<br /><br />
                            <strong style={{ color: '#000' }}>Simbiosis absoluta entre intuici├│n humana y precisi├│n algor├¡tmica.</strong>
                        </p>
                    </div>
                </section>
                ...
                <section className="soul-narrative-section" style={{ position: 'relative', zIndex: 30, backgroundColor: '#000', color: '#FFF' }}>
                    <div style={{ position: 'absolute', top: '15vh', left: '5%', fontFamily: 'var(--font-mono)', color: '#FFF', opacity: 0.5, zIndex: 40, pointerEvents: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        <span style={{ fontSize: '1rem', fontWeight: 600 }}>G├ëNESIS</span>
                    </div>
                    <SoulManifesto />
                </section>
                ...
                <section className="team-list" style={{ minHeight: '100vh', padding: '10vh 0', backgroundColor: '#FFFFFF', color: '#000', display: 'flex', flexDirection: 'column', position: 'relative' }}>
                    <div style={{ position: 'absolute', top: '15vh', left: '5%', fontFamily: 'var(--font-mono)', color: '#000', opacity: 0.5, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        <span style={{ fontSize: '1rem', fontWeight: 600 }}>N├ÜCLEO</span>
                    </div>
                    <h2 style={{ fontSize: 'clamp(3rem, 6vw, 6rem)', marginBottom: '6rem', fontWeight: 900, textAlign: 'center', letterSpacing: '-0.05em', color: '#000' }}>EL N├ÜCLEO</h2>
                    ...
                    <div style={{
                        ...
                        */}
                        ...
                        <p style={{
                            ...
                            Algoritmo L├│gico de Mente Artificial
                        </p>
                        ...
                        <div style={{
                            ...
                            <span style={{
                                ...
                                /// PROPIEDAD INTELECTUAL ÔÇö AGENCIA ┬® 2025
                            </span>
                        </div>
                ...
                <section style={{ minHeight: '100vh', padding: '2rem 0', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: '#FFFFFF', color: '#000', position: 'relative' }}>
                    ...
                    <Link to="/contacto">
                        ...
                        >
                            T├│mate un caf├® virtual con nosotros
                        </button>
                    </Link>
